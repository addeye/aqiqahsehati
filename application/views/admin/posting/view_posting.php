            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right"><a href="<?=site_url('content/tambah_posting')?>" class="btn btn-primary">Tambah</a></div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php $no=1; foreach($page as $row) {?>
                                <tr>
                                    <td><?=$no++?></td>
                                    <td><?=$row->judul?></td>
                                    <td>
                                        <?php
                                        foreach($row->author as $val)
                                        {
...
<input type="hidden" id="url" value="<?=site_url('content/delete_posting/')?>">
