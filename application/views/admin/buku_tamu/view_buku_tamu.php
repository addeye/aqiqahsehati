                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php $no=1; foreach($buku_tamu->result() as $row) {?>
                                <tr>
                                    <td><?=$no++?></td>
                                    <td><?=$row->nama?></td>
                                    <td><?=$row->email?></td>
                                    <td>
                                        <a class="btn btn-success btn-xs" href="<?=site_url('fitur/detail_buku_tamu/'.$row->id)?>">Lihat</a>
...
<input type="hidden" id="url" value="<?=site_url('fitur/delete_buku_tamu/')?>">
