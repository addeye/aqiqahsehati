                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php $no=1; foreach($upload as $row) {?>
                                <tr>
                                    <td><?=$no++?></td>
                                    <td><?=$row->nama_uploader?></td>
                                    <td><?=$row->email?></td>
                                    <td><?=$row->kategori[0]->kategori?></td>
                                    <td>
                                        <a class="btn btn-success btn-xs" href="<?=site_url('fitur/detail_upload/'.$row->id)?>">Lihat</a>
...
<input type="hidden" id="url" value="<?=site_url('fitur/delete_upload/')?>">
