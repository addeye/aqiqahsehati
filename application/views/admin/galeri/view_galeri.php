            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right"><a href="<?=site_url('content/tambah_galeri')?>" class="btn btn-primary">Tambah</a></div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <?php $no=1; foreach($galeri as $row) {?>
                                <tr>
                                    <td><?=$no++?></td>
                                    <td><?=$row->judul?></td>
                                    <td><?=character_limiter($row->keterangan,50)?></td>
                                    <td>
                                        <?php
                                        foreach($row->kategori as $val)
                                        {
                                            echo $val->kategori;
                                        }
                                        ?>
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-xs" href="<?=site_url('content/edit_galeri/'.$row->id)?>">Edit</a>
...
<input type="hidden" id="url" value="<?=site_url('content/delete_galeri/')?>">
