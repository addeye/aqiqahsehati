...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form action="<?=site_url('content/create_galeri')?>" method="post" enctype="multipart/form-data">
            <div class="col-xs-8">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slug-source" name="judul" placeholder="Judul" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Keterangan</label>
                                <textarea class="form-control" id="editor1" name="keterangan" rows="15" required></textarea>
                            </div>
                        </div>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
                    ...
                    <div class="box-body">
                        <div>
                            <div class="form-group">
                                ...
                                <input required type="file" name="gambar" id="exampleInputFile">
                            </div>
                            <div class="form-group">
