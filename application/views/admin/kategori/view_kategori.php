            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right"><a href="<?=site_url('front/tambah_kategori')?>" class="btn btn-primary">Tambah</a></div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php $no=1; foreach($kategori->result() as $row) {?>
                                <tr>
                                    ...
                                    <td><?=$row->slug?></td>
                                    <td>
                                        <a class="btn btn-success btn-xs" href="<?=site_url('front/edit_kategori/'.$row->id)?>">Edit</a>
...
<input type="hidden" id="url" value="<?=site_url('front/delete_kategori/')?>">
