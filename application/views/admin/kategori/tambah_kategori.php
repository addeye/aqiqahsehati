        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" action="<?=site_url('front/create_kategori')?>" method="post">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Kategori</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="slug-source" name="kategori" placeholder="Kategori">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Slug</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="slug-target" name="slug" placeholder="Slug">
                                </div>
                            </div>
                            <div class="form-group">
