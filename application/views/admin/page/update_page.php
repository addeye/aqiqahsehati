...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form action="<?=site_url('content/update_page')?>" method="post" enctype="multipart/form-data">
                <?php $data = $page->row(); ?>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div>
                                ...
                                <div class="form-group">
                                    <img src="<?=base_url('upload/images/'.$data->gambar)?>" class="img-responsive" alt="Gambar">
                                </div>
