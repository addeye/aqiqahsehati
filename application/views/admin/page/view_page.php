            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right"><a href="<?=site_url('content/tambah_page')?>" class="btn btn-primary">Tambah</a></div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
...
<input type="hidden" id="url" value="<?=site_url('content/delete_page/')?>">
