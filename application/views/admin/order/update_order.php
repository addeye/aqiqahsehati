                        ...
                        <div class="box-body">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="telp" name="telp" value="<?=$data->telp?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nomor Hp</label>
                                    <input type="text" class="form-control" placeholder="Nomor Hp" name="nohp" value="<?=$data->nohp?>" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="box-body">
                            <div>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="<?=$data->sedap_4?>" name="sedap_4">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Sedap 3</label>
                                    <input type="number" class="form-control" value="<?=$data->sedap_3?>" name="sedap_3">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Sedap 2</label>
                                    <input type="number" class="form-control" value="<?=$data->sedap_2?>" name="sedap_2">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Sedap 1</label>
                                    <input type="number" class="form-control" value="<?=$data->sedap_1?>" name="sedap_1">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Syukur</label>
                                    <input type="number" class="form-control" value="<?=$data->syukur?>" name="syukur">
                                </div>
                            </div>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
                        ...
                        <div class="box-body">
                            <div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Lengkap" name="nama_anak" value="<?=$data->nama_anak?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Bin /Binti</label>
                                    <input type="text" class="form-control" placeholder="Bin /Binti" name="nama_ortu" value="<?=$data->nama_ortu?>" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" name="jenis_kelamin" id="inlineRadio1" value="L" <?= $data->jenis_kelamin=='L'?'checked':'' ?> > Laki-laki
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="jenis_kelamin" id="inlineRadio2" value="P" <?= $data->jenis_kelamin=='P'?'checked':'' ?> > Perempuan
                                    </label>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
                        ...
                        <div class="box-body">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" placeholder="Tanggal Pelaksanaan" name="pesan_tanggal" value="<?=$data->pesan_tanggal?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Jam</label>
                                    <input type="time" class="form-control" placeholder="Jam" name="pesan_waktu" value="<?=$data->pesan_waktu?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Alamat</label>
                                    <textarea class="form-control" name="pesan_alamat" required><?=$data->pesan_alamat?></textarea>
                                </div>
                                <div class="form-group">
